========================================================================
    DYNAMIC LINK LIBRARY: Kontofunktionen-Projektübersicht
========================================================================

Diese Kontofunktionen-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Kontofunktionen-Anwendung besteht.


Kontofunktionen.vcxproj
...
Kontofunktionen.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Kontofunktionen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
